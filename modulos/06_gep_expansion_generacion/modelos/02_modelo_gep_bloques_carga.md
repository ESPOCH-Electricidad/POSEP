# Modelo 02 — GEP con bloques de carga

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

Este modelo aproxima la operación anual mediante bloques de carga base, medio y pico.

## 2. Enunciado

Determine inversión y generación por bloque minimizando costos de inversión y operación.
...
$$
Energy_{b}=Demand_bh_b
$$

**Explicación.** Cada bloque representa un número de horas del año.
...
Reportar generación anual por bloque, uso de tecnologías y ENS.
