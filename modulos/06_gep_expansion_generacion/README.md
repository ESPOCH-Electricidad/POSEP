...
Los modelos de expansión de generación requieren tecnologías candidatas, años, bloques de carga, costos, disponibilidad y reserva. Use la [Guía AMPL](../../docs/guia_ampl.md) para automatizar escenarios, sensibilidad económica y exportación de resultados.
