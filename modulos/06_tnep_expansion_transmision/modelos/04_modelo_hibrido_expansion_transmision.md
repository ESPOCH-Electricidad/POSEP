# Modelo 04 — Híbrido de expansión de transmisión

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

El modelo híbrido combina detalle DC en corredores relevantes y representación de transporte en zonas simplificadas.

## 2. Enunciado

Compare resultados de expansión usando una formulación mixta que detalle corredores críticos.
...
$$
F_\ell=(\theta_i-\theta_j)/X_\ell\quad \forall \ell\in L_{DC}
$$

**Explicación.** Solo parte de la red usa ecuaciones DC.
...
Reportar diferencia de inversión frente al modelo de transporte y DC.
