# Modelo 02 — Constructivo de refuerzo de red

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

El modelo constructivo usa resultados de congestión para proponer refuerzos de forma iterativa. No reemplaza una optimización completa, pero ayuda a interpretar candidatos críticos.

## 2. Enunciado

Calcule utilización de líneas y proponga el corredor candidato que reduce la mayor congestión.
...
$$
\min Z=\max_{\ell}\left(|F_\ell|/Fmax_\ell\right)
$$
...
$$
u_\ell=|F_\ell|/Fmax_\ell
$$

**Explicación.** Mide el uso relativo de cada corredor.
...
Reportar ranking de congestión y refuerzo recomendado.
