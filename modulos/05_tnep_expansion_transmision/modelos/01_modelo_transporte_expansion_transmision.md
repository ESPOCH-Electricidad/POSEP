# Modelo 01 — Transporte para expansión de transmisión

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

El modelo de transporte representa balance nodal y límites de capacidad sin imponer leyes de flujo DC. Es útil como primera aproximación.

## 2. Enunciado

Decida qué corredores candidatos construir para minimizar inversión y ENS con una representación de transporte.
...
Reportar circuitos construidos, flujos, ENS y costo de inversión.
