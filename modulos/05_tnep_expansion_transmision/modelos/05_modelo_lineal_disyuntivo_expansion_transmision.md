# Modelo 05 — Lineal disyuntivo de expansión de transmisión

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

La formulación disyuntiva activa flujos de líneas candidatas mediante variables binarias.

## 2. Enunciado

Seleccione líneas candidatas con variables binarias y restrinja flujos usando Big-M.
...
$$
\min Z=\sum_{\ell\in L_{cand}}InvCost_\ell y_\ell+\sum_nVOLL\,ENS_n
$$
...
$$
-My_\ell\leq F_\ell\leq My_\ell\quad \forall \ell\in L_{cand}
$$

**Explicación.** Un corredor candidato solo transporta si se construye.

### Vinculación

$$
n_\ell=y_\ell\quad \forall \ell\in L_{cand}
$$

**Explicación.** Para este caso didáctico, cada candidato puede tener un circuito.
...
Reportar candidatos activados, flujos y costo.
