# Modelo 06 — Multietapa de expansión de transmisión

[Menú principal](../../../README.md) · [Volver al módulo](../README.md) · [Actividades](../actividades/README.md) · [Datos](../datos/)

## 1. Contexto del problema

La expansión multietapa decide en qué año construir, considerando crecimiento de demanda.

## 2. Enunciado

Para 2025, 2030 y 2035, determine el cronograma de construcción que minimiza valor presente de inversión y ENS.
...
$$
\min Z=\sum_{y\in Y}\alpha_y\left(\sum_{\ell\in L_{cand}}InvCost_\ell n_{\ell,y}+\sum_nVOLL\,ENS_{n,y}\right)
$$
...
$$
N_{\ell,y}=N_{\ell,y-1}+n_{\ell,y}
$$

**Explicación.** Los circuitos construidos permanecen disponibles en años posteriores.

### Demanda por año

$$
Demand_{n,y}=Demand_n\cdot factor_y
$$

**Explicación.** Escala la demanda base según el crecimiento proyectado.
...
Reportar año de construcción, inversión descontada, ENS y flujos por etapa.
