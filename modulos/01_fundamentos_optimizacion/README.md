...
Los ejemplos del módulo sirven para construir los primeros archivos `.mod`, `.dat` y `.run`. Use las tablas de cada enunciado para preparar el archivo de datos y la [Guía AMPL](../../docs/guia_ampl.md) para traducir conjuntos, parámetros, variables, objetivo y restricciones.
